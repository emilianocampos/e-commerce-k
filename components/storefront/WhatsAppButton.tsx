...
/* ==========================================================================
   Moscú Showroom - WhatsApp Floating Action Button
   ========================================================================== */

export default function WhatsAppButton() {
  const message = encodeURIComponent('Hola TuTienda! Quería hacer una consulta sobre una prenda.');

  return (
    <a
      href={`https://wa.me/5492494123456?text=${message}`}
      target="_blank"
